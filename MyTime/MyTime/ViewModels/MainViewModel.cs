...
namespace FieldService.ViewModels
{
	...
	public class MainViewModel : INotifyPropertyChanged
	{
					...
					using (var file = new IsolatedStorageFileStream("mainpage.xml", FileMode.CreateNew, iso)) {
						byte[] b =
							Encoding.UTF8.GetBytes(
								"<?xml version=\"1.0\" encoding=\"utf-8\" ?><items><magazines>0</magazines><brochures>0</brochures><books>0</books><rvs>0</rvs><bs>0</bs><tracts>0</tracts><notes> </notes></items>");
		...
		public double MainPageMagazines
		{
			get { return GetMainPageDouble("magazines"); }
			set { SetMainPageDouble(value, "magazines"); }
		}

		public double MainPageBrochures
		{
			get { return GetMainPageDouble("brochures"); }
			set { SetMainPageDouble(value, "brochures"); }
		}

		public double MainPageBooks
		{
			get { return GetMainPageDouble("books"); }
			set { SetMainPageDouble(value, "books"); }
		}

		public double MainPageTracts
		{
			get { return GetMainPageDouble("tracts"); }
		...
		public double MainPageReturnVisits
		{
			...
			set { SetMainPageDouble(value, "rvs"); }
		}

		public double MainPageBibleStudies
		{
			get { return GetMainPageDouble("bs"); }
			set { SetMainPageDouble(value, "bs"); }
		}

		public string MainPageNotes
		{
			get { return GetMainPageString("notes"); }
			set { SetMainPageString(value, "notes"); }
		}
		...
		public void LoadMainMenu()
		{
			...
			lbMainMenuItems.Add(new MainMenuModel {
				...
				NavigateToPage = "" //built dynamically in code-behind
			});
